...
jsPsych.plugins['survey-text-mw'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.querySelector('.jspsych-survey-text-question').addEventListener('keypress', function(e) {
      if (e.key === 'Enter') {
        end_trial();
      }
    });
